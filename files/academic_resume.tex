...
& \underline{T. Yang}$^*$, Z. Yao$^*$, B. Jin, L. Cui, Y. Li, G. Wang, X. Liu, W. Neiswanger. \enquote{Demystifying and Enhancing the Efficiency of Large Language Model Based Search Agents.} \textit{ICLR}, 2026. \textit{NeurIPS ER Workshop}, 2025, \textcolor[RGB]{200, 0, 0}{Spotlight.}
\vspace{0.01\textwidth} \\
...
& {National Natural Science Foundation (NSF) of China} \hfill January 2023 -- May 2025 \\
& Working as a core member on improving resource utilization in cloud with QoS guarantee. \vspace{0.01\textwidth} \\

& {Major Project of National NSF of China} \hfill December 2022 -- December 2023 \\
...
& \textbf{Invited talk} on \enquote{Towards Efficient LLM Search Agents} \\
\nohyphens{\textcolor{OliveGreen}{Services}} 
& (\url{https://tiannuo-yang.github.io/talks/efficient_search_agents.pdf}) \\
